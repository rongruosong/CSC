...
class CSCDataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.train_data, batch_size=self.hparams.train_batch_size, collate_fn=collate_csc_mlm_fn_padding)
    
    def val_dataloader(self):
        return DataLoader(self.val_data, batch_size=self.hparams.test_batch_size, collate_fn=collate_csc_mlm_fn_padding)
    
    def test_dataloader(self):
        return DataLoader(self.test_data, batch_size=self.hparams.test_batch_size, collate_fn=collate_csc_mlm_fn_padding)
